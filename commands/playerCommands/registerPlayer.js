...
@param {map} relicInventory, a way to add relics to the game. Also mostly used to keep track of relics created by the game host, and not actual implementation of said relics.
*/
