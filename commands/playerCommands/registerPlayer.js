...
module.exports = {
	...
	async execute(interaction) {
        ...
        if (!pList.playerList.has(interaction.user.id) && interaction.options.getString('name') !== null){
            ...
            // name, realName, score, scoreHistory, scoreHistoryKey, kromer, itemInventory, maxInvSize, relicInventory
            var createPlayer = new Player(interaction.user.username, nameString, 0, new Map(), 0, 0, new Array(), 4, new Array());
